...
import statusController from "../controllers/statusEntrega.controller";
...
router.post("/", [authJwt.verifyToken, authJwt.isAdmin, verifyDuplicate.checkDuplicateStatusEntrega], statusController.createOne);
