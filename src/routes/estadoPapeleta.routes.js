...
import controller from '../controllers/estadoPapeleta.controller'
...
router.post('/', [authJwt.verifyToken, authJwt.isAdmin, verifyDuplicate.checkDuplicateEstadoPapeleta], controller.newOne);
