...
//Crear Seguro
router.post("/", [authJwt.verifyToken, authJwt.isConexosAsistantOrAsesorVentasConexosOrAdmin], seguroCtrl.createOne);

//Actualizar Seguro
router.patch("/:seguroId", [authJwt.verifyToken, authJwt.isConexosAsistantOrAsesorVentasConexosOrAdmin], seguroCtrl.updateOneById);
