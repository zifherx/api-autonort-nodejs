...
router.post('/', [authJwt.verifyToken, authJwt.isAdministradorOrAsistantComercial],resultadoCtrl.createOne);
router.post('/by-sucursal', resultadoCtrl.getAllByProductSedeYear);
router.patch('/:itemId', [authJwt.verifyToken, authJwt.isAdministradorOrAsistantComercial],resultadoCtrl.updateOneById);
