...
var statusTasacionCtrl = {};

statusTasacionCtrl.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _StatusTasacion.default.find().sort({
              value: 'asc'
            });
...
statusTasacionCtrl.getOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _StatusTasacion.default.findById(statusId);
...
statusTasacionCtrl.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _StatusTasacion.default.find({
              estado: true
            }).sort({
              value: 'asc'
            });
...
statusTasacionCtrl.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            nuevo = new _StatusTasacion.default({
              name: name,
              value: value,
              estado: estado
            });
...
statusTasacionCtrl.updateOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _StatusTasacion.default.findByIdAndUpdate(statusId, {
              name: name,
              value: value,
              estado: estado
            });
...
statusTasacionCtrl.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _StatusTasacion.default.findByIdAndDelete(statusId);
...
var _default = statusTasacionCtrl;
exports.default = _default;
//# sourceMappingURL=statusTasacion.controller.js.map