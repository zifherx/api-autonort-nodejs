...
usoController.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _TipoUso.default.find().sort({
              name: 1
            });
          ...
          case 8:
            return _context.abrupt("return", res.status(404).json({
              message: 'No existen tipos de uso'
            }));
...
usoController.getOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _TipoUso.default.findById(usoId);
...
usoController.getAllByActivo = /*#__PURE__*/function () {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: 'No existen tipos de uso activos'
            }));
...
usoController.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            if (query) {
              res.json({
                message: 'Tipo de uso creado con éxito'
              });
            }
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _TipoUso.default.findByIdAndUpdate(usoId, {
              name: name,
              estado: estado
            });
          ...
          case 5:
            ...
            res.json({
              message: 'Tipo de uso actualizado con éxito'
            });
            _context5.next = 11;
            break;
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: 'No existe tipo de uso a eliminar'
            }));
...
usoController.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _TipoUso.default.findByIdAndDelete(usoId);
          ...
          case 4:
            ...
            res.json({
              message: 'Tipo de uso eliminado con éxito'
            });
            _context6.next = 10;
            break;
...
var _default = usoController;
exports.default = _default;
//# sourceMappingURL=tipoUso.controller.js.map