...
var estateController = {};

estateController.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _EstadoUsados.default.find().sort({
              value: 1
            });
...
estateController.getOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _EstadoUsados.default.findById(itemId);
...
estateController.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _EstadoUsados.default.find({
              estado: true
            }).sort({
              value: 1
            });
...
estateController.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            nuevo = new _EstadoUsados.default({
              name: name,
              value: value,
              estado: estado
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _EstadoUsados.default.findByIdAndUpdate(itemId, {
              name: name,
              value: value,
              estado: estado
            });
...
estateController.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _EstadoUsados.default.findByIdAndDelete(itemId);
...
var _default = estateController;
exports.default = _default;
//# sourceMappingURL=estadoUsados.controller.js.map