...
userController.getAllActivos = /*#__PURE__*/function () {
...
userController.getOneById = /*#__PURE__*/function () {
...
userController.updateProfileById = /*#__PURE__*/function () {
  var _ref6 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var userId, _req$body3, name, email, phone, pais, codigo_postal, direccion, about, query;
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            userId = req.params.userId;
            _req$body3 = req.body, name = _req$body3.name, email = _req$body3.email, phone = _req$body3.phone, pais = _req$body3.pais, codigo_postal = _req$body3.codigo_postal, direccion = _req$body3.direccion, about = _req$body3.about;
            _context6.prev = 2;
            _context6.next = 5;
            return _User.default.findByIdAndUpdate(userId, {
              name: name,
          ...
          case 10:
            return _context6.abrupt("return", res.status(404).json({
              messsage: 'No existe perfil a actualizar'
            }));
...
userController.deleteOneById = /*#__PURE__*/function () {
...
userController.countByOnlineStatus = /*#__PURE__*/function () {
