...
var tipoCampaniaCtrl = {};

tipoCampaniaCtrl.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _TipoCampania.default.find().sort({
              name: 1
            });
          ...
          case 8:
            return _context.abrupt("return", res.status(404).json({
              message: 'No existen tipos de campañas'
            }));
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            return _context2.abrupt("return", res.status(404).json({
              message: 'No existe tipo de campaña'
            }));
...
tipoCampaniaCtrl.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _TipoCampania.default.find({
              estado: true
            }).sort({
              name: 1
            });
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: 'No existen tipos de campañas activos'
            }));
...
tipoCampaniaCtrl.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            if (query) {
              res.json({
                message: 'Tipo de campaña creada con éxito'
              });
            }
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            res.json({
              message: 'Tipo de campaña actualizada con éxito'
            });
            _context5.next = 11;
            break;
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: 'No existe tipo de campaña a actualizar'
            }));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            res.json({
              message: 'Tipo de campaña eliminada con éxito'
            });
            _context6.next = 10;
            break;
          ...
          case 9:
            return _context6.abrupt("return", res.status(404).json({
              message: 'No existe tipo de campaña a eliminar'
            }));
...
var _default = tipoCampaniaCtrl;
exports.default = _default;
//# sourceMappingURL=tipoCampania.controller.js.map