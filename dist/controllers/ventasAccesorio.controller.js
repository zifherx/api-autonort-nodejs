...
var _VentasAccesorio = _interopRequireDefault(require("../models/VentasAccesorio"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _VentasAccesorio.default.find().sort({
              fecha: 1
            }).populate({
              path: "sucursalE",
              select: "name"
...
stockController.createOne = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(req, res) {
    var _req$body, cod_interno, sucursal, sucursalE, fecha, anio, anioE, mes, mesE, stock, ventas, createdBy, newObj, sucursalFound, anioFound, mesFound, userFound, query;

    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _req$body = req.body, cod_interno = _req$body.cod_interno, sucursal = _req$body.sucursal, sucursalE = _req$body.sucursalE, fecha = _req$body.fecha, anio = _req$body.anio, anioE = _req$body.anioE, mes = _req$body.mes, mesE = _req$body.mesE, stock = _req$body.stock, ventas = _req$body.ventas, createdBy = _req$body.createdBy;
            _context2.prev = 1;
            newObj = new _VentasAccesorio.default({
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            _context3.next = 4;
            return _VentasAccesorio.default.find({
              sucursal: {
                $regex: ".*" + sucursalE + ".*"
              } // mes: mesE,
...
//# sourceMappingURL=ventasAccesorio.controller.js.map