...
areaCtrl.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _Area.default.find().sort({
              name: 1
            });
...
areaCtrl.getOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _Area.default.findById(areaId);
...
areaCtrl.getAllActivos = /*#__PURE__*/function () {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: 'No existen areas activos'
            }));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _Area.default.findByIdAndUpdate(areaId, {
              name: name,
              estado: estado
            });
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: 'No existe area a eliminar'
            }));
...
areaCtrl.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _Area.default.findByIdAndDelete(areaId);
          ...
          case 4:
            ...
            res.json({
              message: 'Area eliminada con éxito'
            });
            _context6.next = 10;
            break;
