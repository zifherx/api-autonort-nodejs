      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _EstadoSeguro.default.find().sort({
              value: 1
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _EstadoSeguro.default.findById(seguroId);
...
seguroController.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _EstadoSeguro.default.find({
              estado: true
            }).sort({
              value: 1
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            nuevo = new _EstadoSeguro.default({
              name: name,
              value: value,
              estado: estado
            });
...
seguroController.updateOneById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, name, value, estado, seguroId, query;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _EstadoSeguro.default.findByIdAndUpdate(seguroId, {
              name: name,
              value: value,
              estado: estado
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _EstadoSeguro.default.findByIdAndDelete(seguroId);
...
//# sourceMappingURL=estadoSeguro.controller.js.map