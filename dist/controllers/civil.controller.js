...
civilController.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _EstadoCivil.default.find().sort({
              name: 1
            });
          ...
          case 8:
            return _context.abrupt("return", res.status(404).json({
              message: 'No existen estados civiles'
            }));
...
civilController.getOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _EstadoCivil.default.findById(civilId);
          ...
          case 9:
            return _context2.abrupt("return", res.status(404).json({
              message: 'No existe estado civil'
            }));
...
civilController.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _EstadoCivil.default.find({
              estado: true
            }).sort({
              name: 1
            });
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: 'No existen estados civiles activos'
            }));
...
civilController.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _EstadoCivil.default.findByIdAndUpdate(civilId, {
              name: name,
              estado: estado
            });
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: 'No existe estado civil a actualizar'
            }));
...
civilController.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _EstadoCivil.default.findByIdAndDelete(civilId);
          ...
          case 9:
            return _context6.abrupt("return", res.status(404).json({
              message: 'No existe estado civil a eliminar'
            }));
...
var _default = civilController;
exports.default = _default;
//# sourceMappingURL=civil.controller.js.map