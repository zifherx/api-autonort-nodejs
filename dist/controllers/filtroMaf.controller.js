      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _FiltroMaf.default.find().sort({
              name: 1
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _FiltroMaf.default.findById(estadoId);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _FiltroMaf.default.find({
              estado: true
            }).sort({
              name: 1
            });
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: 'No existen filtros activos'
            }));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            ...
            if (query) {
              res.json({
                message: 'Estado de filtro creado con éxito'
              });
            }
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _FiltroMaf.default.findByIdAndUpdate(estadoId, {
              name: name,
              estado: estado,
              value: value
            });
          ...
          case 5:
            ...
            res.json({
              message: 'Estado de filtro actualizado con éxito'
            });
            _context5.next = 11;
            break;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _FiltroMaf.default.findByIdAndDelete(estadoId);
          ...
          case 4:
            ...
            res.json({
              message: 'Estado de filtro eliminado con éxito'
            });
            _context6.next = 10;
            break;
...
//# sourceMappingURL=filtroMaf.controller.js.map