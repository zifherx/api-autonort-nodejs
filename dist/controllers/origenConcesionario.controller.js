...
var origenController = {};

origenController.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _OrigenConcesionario.default.find().sort({
              name: 1
            });
...
origenController.getOneById = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            origenId = req.params.origenId;
            _context2.prev = 1;
            _context2.next = 4;
            return _OrigenConcesionario.default.findById(origenId);
...
origenController.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _OrigenConcesionario.default.find({
              estado: true
            }).sort({
              name: 1
            });
...
origenController.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            obj = new _OrigenConcesionario.default({
              name: name,
              estado: estado
            });
            _context4.next = 5;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _OrigenConcesionario.default.findByIdAndUpdate(origenId, {
              name: name,
              estado: estado
            });
...
origenController.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _OrigenConcesionario.default.findByIdAndDelete(origenId);
...
var _default = origenController;
exports.default = _default;
//# sourceMappingURL=origenConcesionario.controller.js.map