...
comprobanteController.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _TipoComprobante.default.find().sort({
              name: 1
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _TipoComprobante.default.findById(comprobanteId);
...
comprobanteController.getAllActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _TipoComprobante.default.find({
              estado: true
            }).sort({
              name: 1
            });
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: 'No existen comprobantes activos'
            }));
...
comprobanteController.createOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 1;
            obj = new _TipoComprobante.default({
              name: name,
              estado: estado
            });
            _context4.next = 5;
...
comprobanteController.updateOneById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, name, estado, comprobanteId, query;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _TipoComprobante.default.findByIdAndUpdate(comprobanteId, {
              name: name,
              estado: estado
            });
          ...
          case 5:
            ...
            res.json({
              message: 'Comprobante actualizado con éxito'
            });
            _context5.next = 11;
            break;
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: 'No existe comprobante a eliminar'
            }));
...
comprobanteController.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _TipoComprobante.default.findByIdAndDelete(comprobanteId);
...
var _default = comprobanteController;
exports.default = _default;
//# sourceMappingURL=tipoComprobante.controller.js.map