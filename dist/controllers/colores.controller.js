...
exports.updateOneById = exports.getOneById = exports.getAllByActive = exports.getAll = exports.deleteOneById = exports.createOne = void 0;
...
var getAllByActive = /*#__PURE__*/function () {
  ...
  return function getAllByActive(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.getAllByActive = getAllByActive;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            _context3.next = 4;
            return _Colores.default.findById(itemId);
...
var createOne = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body, name, codigo_toyota, hex, estado, newObj, query;

    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, codigo_toyota = _req$body.codigo_toyota, hex = _req$body.hex, estado = _req$body.estado;
            _context4.prev = 1;
            newObj = new _Colores.default({
              name: name,
              codigo_toyota: codigo_toyota,
              hex: hex,
              estado: estado
            });
            _context4.next = 5;
...
var updateOneById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, name, codigo_toyota, hex, estado, itemId, query;

    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _req$body2 = req.body, name = _req$body2.name, codigo_toyota = _req$body2.codigo_toyota, hex = _req$body2.hex, estado = _req$body2.estado;
            itemId = req.params.itemId;
            _context5.prev = 2;
            _context5.next = 5;
            return _Colores.default.findByIdAndUpdate(itemId, {
              name: name,
              codigo_toyota: codigo_toyota,
              hex: hex,
              estado: estado
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: "No existe color ".concat(itemId)
            }));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _Colores.default.findByIdAndDelete(itemId);
