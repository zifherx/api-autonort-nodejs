      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _EstadoTunningAccesorio.default.find().sort({
              valor: 1
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _EstadoTunningAccesorio.default.findById(itemId);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _EstadoTunningAccesorio.default.find({
              estado: true
            }).sort({
              valor: 1
            });
...
estadoController.createOne = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body, name, estado, valor, obj, query;

    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, estado = _req$body.estado, valor = _req$body.valor;
            _context4.prev = 1;
            obj = new _EstadoTunningAccesorio.default({
              name: name,
              estado: estado,
              valor: valor
            });
...
estadoController.updateOneById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var _req$body2, name, estado, valor, itemId, query;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _EstadoTunningAccesorio.default.findByIdAndUpdate(itemId, {
              name: name,
              estado: estado,
              valor: valor
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _EstadoTunningAccesorio.default.findByIdAndDelete(itemId);
...
//# sourceMappingURL=EstadoTunningAccesorios.controller.js.map