...
router.post('/', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isAdmin, _middlewares.verifyDuplicate.checkDuplicateAServicios], _aservicios.default.createOne); //Actualizar Asesor de Servicios
