...
var router = (0, _express.Router)(); //Crear Cliente

router.post('/', customerCtrl.createCustomer); //Obtener Clientes
...
router.post('/find', customerCtrl.getCustomerByDni); //Actualizar Cliente

router.put('/:customerId', customerCtrl.updateCustomerById); //Remover Cliente
