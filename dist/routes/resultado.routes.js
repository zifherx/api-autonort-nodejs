...
router.post('/', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isAdministradorOrAsistantComercial], _resultado.default.createOne);
router.post('/by-sucursal', _resultado.default.getAllByProductSedeYear);
router.patch('/:itemId', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isAdministradorOrAsistantComercial], _resultado.default.updateOneById);
