...
router.post("/", [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isChiefAdvorAdminorAsistantADV], _files.default.createOne);
router.patch("/:filesId", [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isChiefAdvorAdminorAsistantADV], _files.default.updateOneById);
router.delete("/:filesId", [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isChiefAdvorAdmin], _files.default.deleteOneById);
var _default = router;
