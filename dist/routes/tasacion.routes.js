...
router.post('/count/by-estado', [_middlewares.authJwt.verifyToken], _tasacion.default.getCounterByEstado);
router.post('/', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isTasadorOrChiefEDPDOrAdmin], _tasacion.default.createOne);
router.patch('/:tasacionId', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isTasadorOrChiefEDPDOrAdmin], _tasacion.default.updatedOneById);
