...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-dfad60fa"], {
  ...
  5249: function _(t, e, i) {
    ...
    var n = function n() {
      ...
      }, [t._v(" Alta de Usuarios ")])])], 1), i("v-row", [i("v-col", {
        attrs: {
          cols: "12",
          md: "8"
        }
      ...
      methods: {
        ...
        guardarUsuario: function guardarUsuario() {
          var t = this;
          this.users.roles = this.roleSeleccionado;
          var e = this.$router,
              i = this.users;
          o.a.post(l, i).then(function (i) {
            e.push("/usuarios"), t.limpiarCampos();
          }).catch(function (t) {
            console.log(t);
          });
        },
...
//# sourceMappingURL=chunk-dfad60fa.1be79a46.js.map