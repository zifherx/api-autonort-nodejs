...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-41a40532"], {
      ...
      render: function render(a, t) {
        ...
        return s || function () {
          ...
          s.push((a = {
            ...
            "row--dense": n.dense
          }, Object(e["a"])(a, "align-".concat(n.align), n.align), Object(e["a"])(a, "justify-".concat(n.justify), n.justify), Object(e["a"])(a, "align-content-".concat(n.alignContent), n.alignContent), a)), C.set(o, s);
  ...
  "90f8": function f8(a, t, n) {
    ...
    var e = function e() {
      ...
      }, [a._v(" Edición de Campañas ")])])], 1), n("v-row", [n("v-col", {
        attrs: {
          cols: "12",
          md: "8"
        }
      ...
      methods: {
        activarEdicion: function activarEdicion() {
          var a = this;
          this.id = this.$route.params.id, r.a.get(o + this.id).then(function (t) {
            a.campaign = t.data;
          }).catch(function (a) {
            console.log(a);
          });
        ...
        guardarCampania: function guardarCampania() {
          var a = this.$router,
              t = this.campaign;
          r.a.put(o + this.id, t).then(function (t) {
            a.push("/ventas/campañas");
          });
        }
      }
    },
        ...
        v = n("0fd9"),
        h = n("8654"),
        y = Object(u["a"])(s, e, i, !1, null, null, null);
...
//# sourceMappingURL=chunk-41a40532.e4bd0eda.js.map