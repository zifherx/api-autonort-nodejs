...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-41ac0bd4"], {
  "071b": function b(n, t, e) {
    "use strict";
    ...
    var i = function i() {
      ...
      }, [n._v(" Nuevo Tipo de Financiamiento ")])])], 1), e("v-row", [e("v-col", {
        attrs: {
          cols: "12",
          md: "8"
        }
      ...
      methods: {
        guardarFinanciamiento: function guardarFinanciamiento() {
          var n = this,
              t = this.$router,
              e = this.financing;
          o.a.post(r, e).then(function (e) {
            t.push("/ventas/financiamiento"), n.limpiarCampos();
          });
        },
...
//# sourceMappingURL=chunk-41ac0bd4.39f4fe35.js.map