...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-d27703a4"], {
      ...
      render: function render(t, e) {
        ...
        return l || function () {
          ...
          l.push((t = {
            ...
            "row--dense": i.dense
          }, Object(n["a"])(t, "align-".concat(i.align), i.align), Object(n["a"])(t, "justify-".concat(i.justify), i.justify), Object(n["a"])(t, "align-content-".concat(i.alignContent), i.alignContent), t)), x.set(r, l);
  ...
  "3a2f": function a2f(t, e, i) {
    ...
    var n = i("ade3"),
        ...
        d = i("d9bd"),
        p = i("58df");
    e["a"] = Object(p["a"])(a["a"], o["a"], r["a"], c["a"], l["a"], u["a"]).extend({
      name: "v-tooltip",
      props: {
        closeDelay: {
          type: [Number, String],
      ...
      computed: {
        calculatedLeft: function calculatedLeft() {
          var t = this.dimensions,
              ...
              a = 0;
          return this.top || this.bottom || n ? a = s + e.width / 2 - i.width / 2 : (this.left || this.right) && (a = s + (this.right ? e.width : -i.width) + (this.right ? 10 : -10)), this.nudgeLeft && (a -= parseInt(this.nudgeLeft)), this.nudgeRight && (a += parseInt(this.nudgeRight)), "".concat(this.calcXOverflow(a, this.dimensions.content.width), "px");
        },
        calculatedTop: function calculatedTop() {
          var t = this.dimensions,
              ...
              s = 0;
          return this.top || this.bottom ? s = n + (this.bottom ? e.height : -i.height) + (this.bottom ? 10 : -10) : (this.left || this.right) && (s = n + e.height / 2 - i.height / 2), this.nudgeTop && (s -= parseInt(this.nudgeTop)), this.nudgeBottom && (s += parseInt(this.nudgeBottom)), "".concat(this.calcYOverflow(s + this.pageYOffset), "px");
        },
        classes: function classes() {
          return {
      ...
      mounted: function mounted() {
        "v-slot" === Object(h["t"])(this, "activator", !0) && Object(d["b"])("v-tooltip's activator slot must be bound, try '<template #activator=\"data\"><v-btn v-on=\"data.on>'", this);
      },
      methods: {
        ...
        genActivatorListeners: function genActivatorListeners() {
          var t = this,
              e = s["a"].options.methods.genActivatorListeners.call(this);
          return e.focus = function (e) {
            t.getActivator(e), t.runDelay("open");
          }, e.blur = function (e) {
            t.getActivator(e), t.runDelay("close");
          }, e.keydown = function (e) {
            e.keyCode === h["x"].esc && (t.getActivator(e), t.runDelay("close"));
          }, e;
        },
        ...
        genContent: function genContent() {
          ...
          return this.$createElement("div", this.setBackgroundColor(this.color, {
            ...
            class: (t = {}, Object(n["a"])(t, this.contentClass, !0), Object(n["a"])(t, "menuable__content__active", this.isActive), Object(n["a"])(t, "v-tooltip__content--fixed", this.activatorFixed), t),
            style: this.styles,
  ...
  "5c3a8": function c3a8(t, e, i) {
    ...
    var n = function n() {
      ...
      return i("v-container", {
        ...
        scopedSlots: t._u([{
          ...
          fn: function fn() {
            ...
            }, [i("span", [t._v("Refresh")])]), i("v-tooltip", {
              attrs: {
                bottom: ""
              },
              scopedSlots: t._u([{
                ...
                fn: function fn(e) {
                  ...
                  }, "v-btn", n, !1), s), [i("v-icon", [t._v("mdi-pencil")])], 1)];
                }
              }])
            }, [i("span", [t._v("Change Date")])])];
          },
          proxy: !0
        }, {
          key: "actions",
      ...
      }, [t._v(" mdi-arrow-up ")]), i("span", {
        staticClass: "green--text"
      }, [t._v("55%")]), t._v(" increase in today's sales ")], 1)])], 1), i("v-col", {
        attrs: {
          cols: "12",
          lg: "4"
        }
        ...
        staticClass: "card-title font-weight-light mt-2 ml-2"
      }, [t._v(" Completed Tasks ")]), i("p", {
        staticClass: "d-inline-flex font-weight-light ml-2 mt-1"
      }, [t._v(" Last Last Campaign Performance ")])])], 1), i("v-col", {
        attrs: {
          cols: "12",
          sm: "6",
          lg: "3"
        }
      }, [i("base-material-stats-card", {
        attrs: {
          color: "info",
          icon: "mdi-twitter",
          title: "Followers",
        ...
        scopedSlots: t._u([{
          ...
          fn: function fn() {
            return [i("v-tabs", {
              ...
              staticClass: "mr-2"
            }, [t._v(" mdi-bug ")]), t._v(" Bugs ")], 1), i("v-tab", {
              staticClass: "mr-3"
            }, [i("v-icon", {
              staticClass: "mr-2"
            }, [t._v(" mdi-code-tags ")]), t._v(" Website ")], 1), i("v-tab", [i("v-icon", {
              staticClass: "mr-2"
            }, [t._v(" mdi-cloud ")]), t._v(" Server ")], 1)], 1)];
          },
          proxy: !0
        }])
      }, [i("v-tabs-items", {
        ...
        return i("v-tab-item", {
          key: e
        }, [i("v-card-text", [t._l(t.tasks[t.tabs], function (e, n) {
          return [i("v-row", {
            key: n,
            attrs: {
              align: "center"
          ...
          }, [i("v-list-item-action", [i("v-checkbox", {
            attrs: {
              color: "secondary"
            },
            model: {
      ...
      methods: {
        ...
        v = i("1800"),
        b = i("0fd9"),
        y = (i("c975"), i("ac1f"), i("5319"), i("5530")),
        x = i("4e82"),
        O = i("1c87"),
        S = i("7560"),
        $ = i("80d2"),
        C = i("58df"),
        j = Object(C["a"])(O["a"], Object(x["a"])("tabsBar"), S["a"]),
        I = j.extend().extend().extend({
      name: "v-tab",
      props: {
        ripple: {
          type: [Boolean, Object],
      ...
      render: function render(t) {
        var e = this,
            ...
            n = i.tag,
            s = i.data;
        return s.attrs = Object(y["a"])(Object(y["a"])({}, s.attrs), {}, {
          "aria-selected": String(this.isActive),
          role: "tab",
          tabindex: 0
        }), s.on = Object(y["a"])(Object(y["a"])({}, s.on), {}, {
          keydown: function keydown(t) {
            t.keyCode === $["x"].enter && e.click(t), e.$emit("keydown", t);
          }
        ...
        w = i("9d65"),
        P = i("c3f0"),
        k = Object(C["a"])(w["a"], Object(x["a"])("windowGroup", "v-window-item", "v-window")),
        _ = k.extend().extend().extend({
      name: "v-window-item",
      directives: {
        Touch: P["a"]
      },
      ...
      methods: {
        ...
        onBeforeTransition: function onBeforeTransition() {
          this.inTransition || (this.inTransition = !0, 0 === this.windowGroup.transitionCount && (this.windowGroup.transitionHeight = Object($["g"])(this.windowGroup.$el.clientHeight)), this.windowGroup.transitionCount++);
        },
        ...
        onEnter: function onEnter(t) {
          ...
          this.inTransition && this.$nextTick(function () {
            e.computedTransition && e.inTransition && (e.windowGroup.transitionHeight = Object($["g"])(t.clientHeight));
          });
        }
      },
      render: function render(t) {
      ...
      methods: {
        genWindowItem: function genWindowItem() {
          var t = _.options.methods.genWindowItem.call(this);
        ...
        T = i("aac8"),
        A = i("3a2f"),
        E = Object(r["a"])(o, n, s, !1, null, null, null);
  ...
  "8fea": function fea(t, e, i) {
    ...
    var n = i("3835"),
      ...
      methods: {
        genSelectAll: function genSelectAll() {
          ...
          return this.$scopedSlots["data-table-select"] ? this.$scopedSlots["data-table-select"](e) : this.$createElement(x["a"], Object(a["a"])({
    ...
    var P = c["a"].extend({
      ...
      functional: !0,
      props: Object(a["a"])(Object(a["a"])({}, S.options.props), {}, {
        mobile: Boolean
      }),
      render: function render(t, e) {
        var i = e.props,
    ...
    e["a"] = Object(g["a"])(b, T["a"]).extend({
      ...
      methods: {
        ...
        customFilterWithColumns: function customFilterWithColumns(t, e) {
          return E(t, e, this.headersWithCustomFilters, this.headersWithoutCustomFilters, this.customFilter);
        },
        ...
        genDefaultSimpleRow: function genDefaultSimpleRow(t, e) {
          ...
          return this.$createElement(this.isMobile ? D : k, {
            key: Object(r["p"])(t, this.itemKey),
            class: Object(I["b"])(Object(a["a"])(Object(a["a"])({}, n), {}, {
      ...
      return n["a"].extend({
        ...
        render: function render(e, i) {
          var n = i.props,
              s = i.data,
              a = i.children;
          s.staticClass = "".concat(t, " ").concat(s.staticClass || "").trim();
          var o = s.attrs;

          if (o) {
            s.attrs = {};
            var r = Object.keys(o).filter(function (t) {
              if ("slot" === t) return !1;
              var e = o[t];
              return t.startsWith("data-") ? (s.attrs[t] = e, !1) : e || "string" === typeof e;
            });
            r.length && (s.staticClass += " ".concat(r.join(" ")));
          }

          return n.id && (s.domProps = s.domProps || {}, s.domProps.id = n.id), e(n.tag, s, a);
        }
      });
    }

    var a = i("d9f7");
    e["a"] = s("container").extend({
      name: "v-container",
      functional: !0,
      props: {
        id: String,
      ...
      render: function render(t, e) {
        var i,
            ...
            o = e.children,
            r = s.attrs;
        return r && (s.attrs = {}, i = Object.keys(r).filter(function (t) {
          if ("slot" === t) return !1;
          var e = r[t];
          return t.startsWith("data-") ? (s.attrs[t] = e, !1) : e || "string" === typeof e;
        })), n.id && (s.domProps = s.domProps || {}, s.domProps.id = n.id), t(n.tag, Object(a["a"])(s, {
    ...
    var n = i("b85c"),
      ...
      methods: {
        ...
        genFilteredText: function genFilteredText(t) {
          if (t = t || "", !this.searchInput || this.noFilter) return Object(x["l"])(t);
        ...
        genHighlight: function genHighlight(t) {
          return '<span class="v-list-item__mask">'.concat(Object(x["l"])(t), "</span>");
        },
        ...
        getDisabled: function getDisabled(t) {
          return Boolean(Object(x["r"])(t, this.itemDisabled, !1));
        },
        getText: function getText(t) {
          return String(Object(x["r"])(t, this.itemText, t));
        },
        getValue: function getValue(t) {
          return Object(x["r"])(t, this.itemValue, this.getText(t));
        }
      },
      render: function render() {
    ...
    e["a"] = D.extend().extend({
      ...
      computed: {
        ...
        staticList: function staticList() {
          return (this.$slots["no-data"] || this.$slots["prepend-item"] || this.$slots["append-item"]) && Object(_["b"])("assert: staticList should not be called if slots are used"), this.$createElement(O, this.listData);
        },
      ...
      methods: {
        ...
        genIcon: function genIcon(t, e, i) {
          var n = S["a"].options.methods.genIcon.call(this, t, e, i);
          return "append" === t && (n.children[0].data = Object(k["a"])(n.children[0].data, {
            attrs: {
        ...
        genInput: function genInput() {
          ...
          return delete t.data.attrs.name, t.data = Object(k["a"])(t.data, {
            domProps: {
              value: null
            },
            attrs: {
              ...
              autocomplete: Object(x["p"])(t.data, "attrs.autocomplete", "off")
            },
            on: {
        ...
        genListWithSlot: function genListWithSlot() {
          ...
          return this.$createElement(O, Object(a["a"])({}, this.listData), e);
        },
        ...
        getDisabled: function getDisabled(t) {
          return Object(x["r"])(t, this.itemDisabled, !1);
        },
        getText: function getText(t) {
          return Object(x["r"])(t, this.itemText, t);
        },
        getValue: function getValue(t) {
          return Object(x["r"])(t, this.itemValue, this.getText(t));
        },
        ...
        onKeyDown: function onKeyDown(t) {
          ...
          if (!this.isReadonly || t.keyCode === x["x"].tab) {
            var i = t.keyCode,
                n = this.$refs.menu;
            if ([x["x"].enter, x["x"].space].includes(i) && this.activateMenu(), this.$emit("keydown", t), n) return this.isMenuActive && i !== x["x"].tab && this.$nextTick(function () {
              n.changeListIndex(t), e.$emit("update:list-index", n.listIndex);
            }), !this.isMenuActive && [x["x"].up, x["x"].down, x["x"].home, x["x"].end].includes(i) ? this.onUpDown(t) : i === x["x"].esc ? this.onEscDown(t) : i === x["x"].tab ? this.onTabDown(t) : i === x["x"].space ? this.onSpaceDown(t) : void 0;
          }
        },
...
//# sourceMappingURL=chunk-d27703a4.7f73a693.js.map